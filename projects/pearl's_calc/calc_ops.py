...
class Dialog(QDialog, Ui_Dialog):
    def __init__(self, *args, **kwargs):
        ...
        # Setup operations.
        self.pushButton_pos.pressed.connect(
            lambda: self.operation(operator.pos))
        self.pushButton_pow.pressed.connect(
            lambda: self.operation(operator.pow))
        self.pushButton_flo.pressed.connect(
            lambda: self.operation(operator.floordiv))
        self.pushButton_mod.pressed.connect(
            lambda: self.operation(operator.mod))
